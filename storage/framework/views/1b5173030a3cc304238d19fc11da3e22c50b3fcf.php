...
<head>
  ...
  <title>Wellme</title>
  <?php echo app('Illuminate\Foundation\Vite')(['resources/css/app.css', 'resources/js/app.js', 'resources/js/script.js']); ?>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <div class="dropdown-divider"></div>
          <a href="<?php echo e(route('count')); ?>" class="dropdown-item dropdown-header">Перейти к рассчету >></a>
        </div>
      </li>
    </ul>
  </nav>
...
</html><?php /**PATH /opt/lampp/htdocs/first_project/resources/views/layouts/admin.blade.php ENDPATH**/ ?>