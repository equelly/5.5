...
<div class="box-container">
    ...
    <div class="box">
        ...
        <a href="<?php echo e(route('post.index')); ?>"> <i class="fas fa-arrow-right"></i>к рецептам</a>
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view', auth()->user())): ?>
        <a href="<?php echo e(route('post.myrecipe')); ?>"> <i class="fas fa-arrow-right"></i>мои рецепты</a>
        <?php endif; ?>
        <a href="<?php echo e(route('product.index')); ?>"> <i class="fas fa-arrow-right"></i>к каталогу продуктов</a>
