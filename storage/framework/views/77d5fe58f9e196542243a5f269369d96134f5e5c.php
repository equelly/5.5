    ...
    <div class="ml-5">
            ...
            <div class="card m-4 w-75">
               ...
               <input type="text" class="" style="width: 10rem; border-bottom: 2px solid #bdf5b0" placeholder = "<?php echo e($post->carbpercent); ?>">
                ...
                <?php if((auth()->user() && auth()->user()->role == 'admin') || (Auth::user()->id == $post->user_id)): ?>
...
<?php echo $__env->make('layouts.guest', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/first_project/resources/views/post/show.blade.php ENDPATH**/ ?>