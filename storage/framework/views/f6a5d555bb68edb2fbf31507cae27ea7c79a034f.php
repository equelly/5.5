...
<h1 class="title"> Категория <span>
   ...
   </span>  <a href="<?php echo e(route('product.index')); ?>" class="btn">К каталогу</a></h1>
...
<?php echo $__env->make('layouts.guest', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/5.5/resources/views/product/showByCategory.blade.php ENDPATH**/ ?>